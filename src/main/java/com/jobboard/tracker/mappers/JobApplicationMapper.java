...
public interface JobApplicationMapper {
	...
	public long addNewApplication(JobApplicationEntity jobApplication);
	...
	public JobApplicationEntity findApplicationById(long id);
	...
	public long updateJobApplication(JobApplicationEntity jobApplication);
	...
	public ArrayList<JobApplicationEntity> fetchJobApplications(long startId, long numberOfRecords, long userId, long univId);
	...
	@Select("select count(*) from job_applications_table where user_id = #{userId} and univ_id = #{univId} and company = #{company} and job_id = #{jobId} and status = #{status}")
	public int findApplicationByUniqueIdentifiersWithEntity(JobApplicationEntity jobApplication);
